            ...
            <div class="row mt-sm-4">
                <div class="col-12 col-md-12 col-lg-5">
                    ...
                    <div class="card">
                        ...
                        <form method="POST" action="{{ route('backend.users.profiles.update.email') }}">
                            @csrf
                            @method('put')
                            <div class="card-body">
                                <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-7">
                    <div class="card">
                        ...
                        <form method="post" action="{{ route('backend.users.profiles.update.profile') }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <form method="post" action="{{ route('backend.users.profiles.update.password') }}">
                            @csrf
                            @method('put')
                            <div class="card-body">
                                <div class="row">
